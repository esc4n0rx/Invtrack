...
export function SuppliersTable({ contagens, loading }: SuppliersTableProps) {
  if (loading) {
    return (
      <Card className="bg-gray-900 border-gray-700">
        <CardContent className="p-6">
          <div className="flex items-center justify-center h-32">
            ...
            <span className="ml-3 text-gray-400">Carregando dados de fornecedores...</span>
          </div>
        </CardContent>
      </Card>
    )
    ...
    return (
      <Card className="bg-gray-900 border-gray-700">
        ...
        <CardContent className="p-6 text-center">
          <p className="text-gray-400">Nenhum recebimento de fornecedor encontrado</p>
        </CardContent>
      </Card>
    )
  }
    ...
    >
      <Card className="bg-gray-900 border-gray-700">
        <CardHeader>
          <CardTitle className="flex items-center gap-2 text-gray-100">
            <Building className="h-5 w-5 text-blue-400" />
            Recebimentos de Fornecedores ({contagens.length})
          </CardTitle>
        </CardHeader>
                  ...
                  >
                   ...
                   <TableCell className="text-gray-300">
                     <div className="flex items-center gap-2">
                       ...
                       <span className="font-medium">{contagem.fornecedor}</span>
                     </div>
                   </TableCell>
